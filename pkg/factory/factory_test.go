...
func TestFactory_ToController(t *testing.T) {
	...
	c = f.WithSyncContext(controller.NewSyncContext("new-context", eventstesting.NewTestingEventRecorder(t))).ToController("test", eventstesting.NewTestingEventRecorder(t))
	b = c.(*controller.baseController)
	...
	informer := &controller.fakeInformer{}
	...
	informer.eventHandler.OnAdd(&v1.Secret{}, false)
	if !queueFuncUsed {
